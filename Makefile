...
VERSION ?= 0.0.1
IMAGE_TAG_BASE ?= derlin.ch/config-cr-operator
...
## marker
	cat target/kubernetes/configs.example.derlin.ch-v1.yml target/kubernetes/dbs.example.derlin.ch-v1.yml target/kubernetes/kubernetes.yml | operator-sdk generate bundle -q --overwrite --version 0.1.1 --default-channel=stable --channels=stable --package=config-cr-operator
